...
renderView1.ViewSize = [220, 600]
renderView1.InteractionMode = '2D'
renderView1.AxesGrid = 'GridAxes3DActor'
renderView1.OrientationAxesVisibility = 0
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [6.699764094067737, 20.05106688668262, 10000.0]
renderView1.CameraFocalPoint = [6.699764094067737, 20.05106688668262, 0.0]
...
time = 30 * int(number) / 100

output_name = 'richtmeyer_meshkov_' + str(int(time)) + '.png'
