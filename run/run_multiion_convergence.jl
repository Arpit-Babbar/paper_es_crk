...
using Tenkai: VolumeIntegralWeak, False, True
...
degree = 3
# solver = cRK33()
volume_integral = VolumeIntegralWeak(cheap_noncons_extrapolation = False())
solver = cRK33(volume_integral = volume_integral)
solution_points = "gl"
